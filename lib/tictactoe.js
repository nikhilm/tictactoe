...
var GameRouter = Backbone.Router.extend({
    ...
    play: function(id) {
        ...
        var model = this.setUpGame({
            ...
            setTimeout(function() {publisher.send({
                "action": "gameover",
                "senderState": model.get('gameover')
            })}, 1000);
        }, this);

        subscriber.bind('gameover', function(state) {
            var mismatch = false;
    ...
    host: function(id) {
        ...
        window.subscriber.bind('start', function(start) {
            ...
            window.subscriber.bind('gameover', function(state) {
                var mismatch = false;
    ...
    setUpGame: function(modelAttrs) {
        var model = new GridModel(modelAttrs);
